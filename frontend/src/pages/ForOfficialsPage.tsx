...
export default function ForOfficialsPage(): React.JSX.Element {
  ...
  const workflowSteps = [
    {
      ...
      badge: "Step 01",
      description:
        "Review commodity, package, instrument, and compliance information.",
    },
    {
      number: "02",
      title: "Assess",
      ...
      badge: "Step 02",
      description:
        "Evaluate relevant declarations, measurements, documentation, and applicable requirements.",
    },
    {
      number: "03",
      title: "Identify",
      ...
      badge: "Step 03",
      description:
        "Identify potential violations, inconsistencies, missing information, and risk patterns.",
    },
    {
      number: "04",
      title: "Verify",
      ...
      badge: "Step 04",
      description:
        "Review the available evidence before making a compliance or enforcement decision.",
    },
    {
      number: "05",
      title: "Record",
      ...
      badge: "Step 05",
      description:
        "Digitally record observations, findings, and enforcement actions.",
    },
    {
      number: "06",
      title: "Track",
      ...
      badge: "Step 06",
      description:
        "Maintain a traceable history of compliance activity for future reference.",
    },
  ]
        ...
        <main className="relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto pt-4 pb-12">
            ...
            <p className="mt-4 text-base sm:text-lg leading-relaxed text-slate-200/90">
              Tools to assess compliance, review evidence, and maintain traceable enforcement records.
            </p>
          </div>
          ...
          <div className="my-14 rounded-3xl border border-white/20 bg-slate-950/40 p-8 sm:p-10 shadow-[0_24px_60px_rgba(2,6,23,0.35)] backdrop-blur-md text-center max-w-4xl mx-auto">
            ...
            <h3 className="text-2xl sm:text-3xl font-black tracking-tight text-white">
              Built for accountable enforcement
            </h3>

            <p className="mt-4 text-sm sm:text-base leading-relaxed text-slate-200/90 max-w-2xl mx-auto">
              Give authorized officials a structured way to review compliance information and maintain clear, traceable records throughout the enforcement process.
            </p>
